...
public class TrabalhoProducao extends Trabalho implements Serializable {
    ...
    public TrabalhoProducao(String id,String nome,String profissao,String raridade, Integer nivel,Integer experiencia,String tipoLicenca, Integer estado,Boolean recorrencia) {
